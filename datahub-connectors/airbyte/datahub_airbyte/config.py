...
class AirbyteConnectionSourceConfig(ConfigModel):
    ...
    Attributes:
        ...
        airbyte_client_id: Client ID for Airbyte API authentication.
        airbyte_client_secret: Client secret for Airbyte API authentication.
        airbyte_server_url: Base URL of the Airbyte API.  Defaults to Airbyte
            Cloud (``https://api.airbyte.com/v1``).  For self-hosted instances
            use e.g. ``http://localhost:8000/api/public/v1/``.
    ...
    Example recipe snippet::
        ...
        source:
          ...
          config:
            ...
            airbyte_server_url: ${AIRBYTE_SERVER_URL}
            environment: "prod"
    """
